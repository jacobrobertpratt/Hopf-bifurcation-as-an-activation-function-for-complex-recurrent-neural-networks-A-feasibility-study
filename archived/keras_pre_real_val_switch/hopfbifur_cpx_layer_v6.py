...
#        _print( 'z' , z , summarize = -1 )
        ...
        zn_j = self.hermitian_map( Cw , nz ) + 1.j*self.hermitian_map( Sw , nz )
        xn_j = self.hermitian_map( Cu , nx ) + 1.j*self.hermitian_map( Su , nx )
...
#        _print( 'dz_t' , dz_t )
        ...
        alph = dz_t
        beta = ( z0_j + x0_j )*self.sones
#        _print( 'alph' , alph )
#        _print( 'beta' , beta )
        
        x_t = x * self.activation( self.sones , alph , beta )
#        x_t = tf.keras.activations.tanh( dz_t )
#        _print( 'x_t' , x_t )
