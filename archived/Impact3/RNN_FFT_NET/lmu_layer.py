...
#        tf.print('m:\n',m,'\nshape:',m.shape,' dtype:',m.dtype,'\n')
        ...
        if self.discretizer == "zoh" and self.trainable_theta:
            ...
            A, B = LMUCell._cont2discrete_zoh(self._base_A * self.theta_inv, self._base_B * self.theta_inv)
        else:
            A, B = self.A, self.B
...
class LMU(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        tf.print('LMU:__init__ -> self.kernel_initializer:',self.kernel_initializer,'\n')
    ...
    def build(self, input_shapes):
        ...
        tf.print('LMU:build -> self.hidden_to_memory:',self.hidden_to_memory,'\n')
        tf.print('LMU:build -> self.memory_to_memory:',self.memory_to_memory,'\n')
        tf.print('LMU:build -> self.trainable_theta:',self.trainable_theta,'\n')
        ...
        if (
            ...
            tf.print('LMU:build -> Creating LMUFeedforward Layer\n')
            ...
            tf.print('LMU:build -> Creating RNN Layer\n')
