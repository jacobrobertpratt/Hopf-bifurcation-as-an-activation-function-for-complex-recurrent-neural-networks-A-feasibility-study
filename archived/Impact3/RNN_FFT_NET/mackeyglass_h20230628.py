...
#    print('y_glass:\n',y_glass,'\nshape:',y_glass.shape,'  dtype:',y_glass.dtype,'\n')
    ...
    train_batch_size = int(train_size/feature_size)
    
    # Setup training and testing data
    train = train[0:train_size]
    train = np.reshape(train,(train_batch_size,1,feature_size))
    test = train.copy()
    train = train[0:-1]
    test = test[1::]
...
#    exit(0)
    ...
    valid_batch_size = int(valid_size/feature_size)
    valid = np.reshape(valid,(valid_batch_size,1,feature_size))
...
#    do_work = False
    ...
    if do_work is True:
        ...
        epoch_size = 2
        num_epochs = 2
        max_valid_len = valid_batch_size
        print_weights = False
        do_self_test = True
...
#    plt.plot(mod_fit.history['accuracy'])
    ...
    cnt = 0
    tst_len = 100 # valid_batch_size
    print('tst_len:',tst_len)
