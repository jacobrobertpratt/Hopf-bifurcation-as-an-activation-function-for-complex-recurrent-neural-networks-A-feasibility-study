...
def create_struct(model_name,train_dir):
    ...
    gen = 0               # The itteration of this training
...
def finalize_struct(
    ...
    if len(metrics) == 0: metrics = [tf.keras.metrics.MeanAbsolutePercentageError(name='mape')]
...
#    with tf.device('/cpu:0'):
    ...
    dense = tf.keras.layers.Dense(16, activation=None)(pratt)
